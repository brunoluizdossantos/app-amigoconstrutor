...
export class BlogProvider {
    ...
    listaCidadesPorEstado(idEstado)
    {
    ...
    cadastroApp(nome, email, cpf, senha, perfil, profissao, rg, sexo, nascimento, celular, telefone, endereco, numero, bairro, complemento, cep, estado, cidade, aceite)
    {
